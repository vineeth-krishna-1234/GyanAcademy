        ...
        <div>
            <div className='w-screen h-[670px] pl-[146px] bg-background flex justify-between'>
                <div className='w-[465px] pt-[101px] inline-flex flex-col gap-[45px]'>
                    ...
                    <p className='h-[96px] text-[22px] leading-[32px]'>Develop critical tech skills. Cut cycle times. Build happier, healthier tech teams. And transform your goals into gains. </p>
                    <button className=' shadow-button rounded-[6px] font-bold text-white  bg-gradient-to-b from-[#282B85E5] to-[#9A1D80E5] w-[139px] h-[49px] text-[17px] ' >Know More</button>
                </div>
                ...
                <div className='pt-[108px] pl-[134px] flex gap-[30px]'>
                    ...
                    <div className=' rounded-[22px] shadow-home_box bg-gradient-to-br from-[#FFFFFF66] to-[#00000000] backdrop-blur-[14px] w-[371px] h-[214px]'>
                        <div className='pl-[25px] pt-[23px]'>
                            ...
                            <p>Escalate your career with our bootcamps, designed to build depth of knowledge and ability in the most in-demand tech skills.</p>
                            <a href=''>Read More</a>
                        </div>
                    </div>
